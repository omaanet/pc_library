// src/config/fonts.ts
import { Inter, Dancing_Script, Playfair_Display, Merriweather, Lora, Crimson_Text, EB_Garamond } from 'next/font/google';
...
// Example alternatives: Playfair_Display, Merriweather, Lora, Crimson_Text
